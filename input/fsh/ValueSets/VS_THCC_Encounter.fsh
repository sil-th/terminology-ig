...
* include codes from system CS_THCC_ServicePriority
...
* include codes from system CS_THCC_ServiceLocationType
...
* include codes from system CS_THCC_ServiceTypeTH
...
* include codes from system CS_THCC_IpdJourney
...
* include codes from system CS_THCC_EncounterDiagnosisRole
