...
* include codes from system CS_THCC_MedicationSource
...
* include codes from system CS_THCC_MedicationCategory
...
* include codes from system CS_THCC_MedOutNLEM
...
* include codes from system CS_THCC_MedDelivery
